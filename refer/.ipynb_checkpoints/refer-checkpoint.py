...
class REFER:
    ...
    def __init__(self, data_root, dataset='refcoco', splitBy='unc'):
        ...
        self.data['images'] = instances['images'] # ? 확인
        self.data['annotations'] = instances['annotations'] # ? 확인
        self.data['categories'] = instances['categories'] # ? 확인하기
        print(self.data['images'], len(self.data['images']))
        print(self.data['annotations'], len(self.data['annotations']))
        print(self.data['categories'], len(self.data['categories']))
